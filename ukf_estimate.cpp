...
void writeInMeasurement(){
  ...
  //ROS_INFO("body:a_g(x) = %f, a_g_(y) = %f, a_g_(z_ = %f", a_g_body(0), a_g_body(1), a_g_body(2));
...
*/
  ...
  //ROS_INFO("ax = %f, ay = %f, az = %f", measurement.measurement_[StateMemberAx], measurement.measurement_[StateMemberAy], measurement.measurement_[StateMemberAz]);
